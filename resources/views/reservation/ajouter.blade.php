...
<div id="wrapper" class="d-flex">
    ...
    <div class="d-flex flex-column w-100 p-4">
        ...
        <div class="form-wrapper">
            <h1><i class="fas fa-calendar-plus"></i> Réserver une salle</h1>
            ...
            <form method="POST" action="{{ route('handleReservationAjouter') }}">
                ...
                <div class="full-width">
                    <label for="user">Utilisateur connecté :</label>
                    <input type="text" id="user" name="user" value="{{ Auth::user()->email }}" readonly>
                </div>
                ...
                <div>
                    ...
                    <input type="date" id="date_reservation" name="date_reservation" min="{{ date('Y-m-d')}}" placeholder="JJ/MM/AAAA" required>
                </div>
