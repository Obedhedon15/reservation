        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="d-flex">
                    ...
                    <a href="{{ route('reservation.liste') }}" class="btn btn-custom">Statut reservation</a>
                </div>
                
            </div>
            <br> <br><a href="/" class="fas fa-sign-out-alt">Deconnexion</a>
        </div>
    </nav>
                    ...
                    @foreach ($salles as $salle)
                        <div class="col-md-6 col-lg-4 d-flex">
                            <div class="card h-100 animated">
                                ...
                                <a href="{{ route('paiements.ajouter', $salle->id) }}" class="btn btn-primary-custom mt-auto">Reserver cette salle</a>
